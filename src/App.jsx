...
function LoginPage() {
  ...
  const loginCSS = `
    ...
    @media(max-width:768px){.login-split{flex-direction:column}.login-left{padding:48px 32px;border-right:none;border-bottom:1px solid rgba(255,255,255,0.1)}.login-right{width:100%;padding:32px 24px}.login-title{font-size:32px}}
  `;
      ...
      <div className="login-wrap">
        ...
        <div className="login-split">
          <div className="login-left">
            <div className="login-eyebrow">Gestión de proyectos</div>
            <div className="login-logo-row">
              <img src="/PL.png" alt="Projects" className="login-logo-img" onError={e => { e.currentTarget.style.display = "none"; }} />
            </div>
            <div className="login-title">PROJECTS<span>TERRA MARE</span></div>
            <div className="login-line" />
            <div className="login-sub">Gantt, camino crítico y seguimiento de proyectos del grupo.</div>
          </div>
          <div className="login-right">
            <div className="login-card">
              ...
              <div className="login-fg">
                <label>Email</label>
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} onKeyDown={handleKey} placeholder="usuario@grupopl.com.ar" autoFocus />
              </div>
              <div className="login-fg">
              ...
              <div className="login-foot">Terra Mare Group · Projects · Confidencial</div>
            </div>
          </div>
        </div>
      </div>
